...
import com.mashow.presentation.databinding.FragmentLoginBinding
import com.mashow.presentation.ui.main.MainActivity
import com.mashow.presentation.util.Constants.GOOGLE
import com.mashow.presentation.util.Constants.KAKAO
import com.mashow.presentation.util.Constants.TAG
...
class LoginFragment : BaseFragment<FragmentLoginBinding>(R.layout.fragment_login) {
    ...
    fun googleLogin() {
        val gso = GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
            .requestIdToken("965624687141-bb642it7i3jo0c6jv4f8798k1e7q660d.apps.googleusercontent.com")
            .requestServerAuthCode("965624687141-bb642it7i3jo0c6jv4f8798k1e7q660d.apps.googleusercontent.com")
            .requestEmail()
            .build()
