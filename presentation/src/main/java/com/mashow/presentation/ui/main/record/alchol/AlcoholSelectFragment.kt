...
import com.mashow.presentation.databinding.FragmentAlcoholSelectBinding
import com.mashow.presentation.ui.main.MainViewModel
import com.mashow.presentation.ui.main.record.alchol.adapter.AlcoholSelectAdapter
import com.mashow.presentation.ui.main.record.alchol.adapter.SelectedAlcoholAdapter
    ...
    private val pageChangeCallback = object : ViewPager2.OnPageChangeCallback() {
        override fun onPageScrolled(
            ...
            when (position) {
                ...
                1 -> binding.ivBackground.setImageResource(R.drawable.background_liquor)
