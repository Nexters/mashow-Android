...
enum class Alcohol(
    ...
    HIGHBALL("하이볼", R.drawable.text_highball, R.drawable.image_highball, R.drawable.btn_highball_added),
    COCKTAIL("칵테일", R.drawable.text_cocktail, R.drawable.image_cocktail, R.drawable.btn_cocktail_added),
    WINE("와인", R.drawable.text_wine, R.drawable.image_wine, R.drawable.btn_wine_added),
    MAKGEOLLI("막걸리", R.drawable.text_makguli, R.drawable.image_makguli, R.drawable.btn_makguli_added)
}
